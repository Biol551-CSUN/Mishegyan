...
topt_site_data %>%
  group_by(fragment.ID, rate.type, E, Eh, lnc, Th, Topt, site.letter, name, site.block, parameter.measured, values, rate_type) %>%
...
ggsave(here("week_6","output","lab_practice_RMarkdown_2023_03_02.png"), # names and saves ggplot
